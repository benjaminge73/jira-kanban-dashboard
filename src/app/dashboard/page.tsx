...
export default async function DashboardPage({
    ...
    type PivotRow = { status: string } & Record<string, number | string | null>

    const pivotTimeStatusData: PivotRow[] = []
    const statusGroups = rawTimeStatusData.reduce<Record<string, StatusGroup>>((acc, row) => {
        if (!acc[row.status]) {
